                ...
                <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="{{url('dashboard/schedule/' .$tbl_ticket->schedule_id)}}">{{$tbl_ticket->schedule_id}}</a></td>
                      ...
                      <tr>
                        ...
                        <td><a href="{{url('dashboard/bus-seat/' .$tbl_ticket->bus_seat_id)}}">{{$tbl_ticket->bus_seat_id}}</a></td>
                        <td>{{$tbl_ticket->bus_seat->seat_number}}</td>
                        <td>{{$tbl_ticket->bus_seat->bus->bus_plate}}</td>
                      </tr>
                      <tr>
                        <th scope="row">Payment</th>
                        <td><a href="{{url('dashboard/payment/' .$tbl_ticket->payment_id)}}">{{$tbl_ticket->payment_id}}</td>
                        <td>{{$tbl_ticket->payment->payment_method}}</td>
                        <td></td>
                      </tr>
                      <tr>
                        <th scope="row">User</th>
                        <td><a href="{{url('dashboard/payment/' .$tbl_ticket->user_id)}}">{{$tbl_ticket->payment->user_id}}</a></td>
                        <td>{{$tbl_ticket->payment->user->username}}</td>
                        <td></td>
                      </tr>
                      <tr>
                        <th scope="row">Storage</th>
                        <td><a href="{{url('dashboard/payment/' .$tbl_ticket->storage_id)}}">{{$tbl_ticket->storage_id}}</a></td>
                        <td>{{$tbl_ticket->storage->luggage}} {{$tbl_ticket->storage->measurement}} </td>
                        <td></td>
                      </tr>
                      <tr>
                        <th scope="row">Price</th>
                        <td><a href="{{url('dashboard/payment/' .$tbl_ticket->price_id)}}">{{$tbl_ticket->price_id}}</a></td>

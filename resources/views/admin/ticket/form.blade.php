...
<div>
    ...
    <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full" id="issued_date" name="issued_date" type="date" value="{{ isset($ticket->issued_date) ? $ticket->issued_date : ''}}" >

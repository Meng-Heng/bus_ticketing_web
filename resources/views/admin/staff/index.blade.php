                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            @foreach($staff as $item)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-5 py-4">{{ $item->fname }}</td><td class="px-5 py-4">{{ $item->lname }}</td><td class="px-5 py-4">{{ $item->user_id }}</td><td class="px-5 py-4">{{ $item->picture }}</td><td class="px-5 py-4">{{ $item->hometown }}</td><td class="px-5 py-4">{{ $item->identification }}</td><td class="px-5 py-4">{{ $item->residency }}</td><td class="px-5 py-4">{{ $item->contact }}</td><td class="px-5 py-4">{{ $item->is_active }}</td><td class="px-5 py-4">{{ $item->position }}</td>
                                    <td class="px-5 py-4">
